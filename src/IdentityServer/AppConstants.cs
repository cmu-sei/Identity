...
namespace IdentityServer
{
    ...
    {
        public const string Audience = "identity-api";
        public const string PrivilegedAudience = "identity-api-privileged";
        public const string PrivilegedPolicy = "identity-api-privileged";
        public const string ManagerRole = "manager";
        public const string AdminRole = "administrator";
        public const string DataProtectionPurpose = "dataprotection.identityserver";
